...
<head>
    ...
    <!----======== CSS ======== -->
    <link rel="stylesheet" href="Styles/SdbarA.css">
        ...
        <header>
            <div class="image-text">
                ...
                <div class="text logo-text">
                    ...
                    <span class="profession">G&eacute;rer mes achats</span>
                </div>
            </div>
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        ...
                        <i class="fa fa-cart-arrow-down icon"></i>
                            <span class="text nav-text">Mes achats</span>
                        </a>
                    </li>
                </ul>
            </div>
